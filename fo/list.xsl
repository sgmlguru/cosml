...
<xsl:stylesheet 
    ...
    <xsl:template match="list/list-item/list[@type='unordered' or not(@type)]/list-item">
        ...
        <fo:list-item>
            <fo:list-item-label start-indent="{$start-indent}" end-indent="label-end()">
                <fo:block> - </fo:block>
            </fo:list-item-label>
            <fo:list-item-body start-indent="{$start-indent} + 5mm" end-indent="13mm">
                <fo:block>
                    <xsl:apply-templates/>
                </fo:block>
            </fo:list-item-body>
    ...
    <xsl:template match="list/list-item/list[@type='ordered']/list-item">
        ...
        <fo:list-item>
            <fo:list-item-label start-indent="{$start-indent}" end-indent="12mm">
                <fo:block>
    ...
    <xsl:template match="step-list/step/list[@type='ordered']/list-item">
        <fo:list-item>
            ...
            <fo:list-item-body start-indent="15mm" end-indent="13mm">
                <fo:block>
                    <xsl:apply-templates/>
                </fo:block>
            </fo:list-item-body>
    ...
    <xsl:template match="def-item">
        <fo:block keep-together.within-page="always" space-before="6pt">
