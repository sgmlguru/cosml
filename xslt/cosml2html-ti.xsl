<!-- XSLT stylesheet to convert COSML to HTML --><!-- Based on IOML conversion XSLT --><!-- 2010-01-28 Condesign Operations Support AB -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="xlink xsl" version="2.0">
